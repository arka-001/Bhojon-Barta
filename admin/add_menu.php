...
if (isset($_POST['submit'])) {
    if (empty($_POST['d_name']) || empty($_POST['about']) || $_POST['price'] == '' || $_POST['res_name'] == '' || empty($_POST['diet_type'])) {
        ...
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
            if ($fsize >= 1000000) {
                ...
                $sql = "INSERT INTO dishes(rs_id, title, slogan, price, img, diet_type) VALUES('".$_POST['res_name']."', '".$_POST['d_name']."', '".$_POST['about']."', '".$_POST['price']."', '".$fnew."', '".$_POST['diet_type']."')";
                mysqli_query($db, $sql);
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="diet_type" class="form-control custom-select" data-placeholder="Choose a Diet Type" tabindex="1">
