																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo ' <tr><td>'.$rows['username'].'</td>
																								...
																								<td>'.$rows['date'].'</td>
																									 <td>
                                                                                                         <a href="javascript:void(0);" onclick="confirmDelete(\'' . $rows['u_id'] . '\')" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a>
