...
console.log("foodpicky.min.js loaded"); // <--- ADD THIS LINE

$(window).on('load', function() {  // <--- Wrap everything in $(window).on('load', ...)
    $(document).ready(function() {
        "use strict";

        console.log("animsition is", $(".animsition")); // <--- ADD THIS LINE
