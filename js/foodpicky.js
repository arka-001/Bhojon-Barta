...
$(document).ready(function() {
    ...
    // Check if animsition plugin is available before initializing
    if ($.fn.animsition) { // <--- This is the crucial check!
        ...
        console.warn("Animsition plugin not found.  Make sure animsition.min.js is loaded correctly.");
    }
